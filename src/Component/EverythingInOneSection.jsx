    ...
    >
      ...
      <div className="relative z-[2] max-w-[1060px] mx-auto">
        ...
        <div className="eiop__layout flex items-start justify-center gap-3 sm:gap-6 max-w-[940px] mx-auto w-full">
          ...
          {/* Left Callout Column */}
          <div
            className="eiop__callout--left flex-1 max-w-[210px] flex flex-col items-end text-right pt-6 transition-all duration-700 delay-200"
          ...
          >
            <div className="bg-[rgba(18,24,18,0.85)] border border-[rgba(126,211,33,0.25)] rounded-xl p-3.5 backdrop-blur-md shadow-[0_8px_24px_rgba(0,0,0,0.5),0_0_15px_rgba(126,211,33,0.1)] transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(126,211,33,0.5)]">
              <p className="text-[0.8rem] text-[#a3e635] leading-[1.45] italic m-0">
          ...
          >
            ...
            >
              ...
              {/* SAVE 80% Badge */}
              <div className="absolute top-3 right-3 z-[5] bg-gradient-to-br from-[#7ed321] to-[#a3e635] text-[#080808] font-mono text-[0.62rem] font-extrabold tracking-[0.08em] px-2.5 py-0.5 rounded-full shadow-[0_2px_10px_rgba(126,211,33,0.5)] eiop__ribbon-pulse">
                SAVE 80%
              </div>
          ...
          <div
            className="eiop__callout--right flex-1 max-w-[210px] flex flex-col items-start text-left pt-6 transition-all duration-700 delay-200"
            style={{ opacity: visible ? 1 : 0, transform: visible ? 'translateX(0)' : 'translateX(24px)' }}
          >
            <div className="bg-[rgba(18,24,18,0.85)] border border-[rgba(126,211,33,0.25)] rounded-xl p-3.5 backdrop-blur-md shadow-[0_8px_24px_rgba(0,0,0,0.5),0_0_15px_rgba(126,211,33,0.1)] transition-all duration-300 hover:-translate-y-1 hover:border-[rgba(126,211,33,0.5)]">
              <p className="text-[0.8rem] text-[#a3e635] leading-[1.45] italic m-0">
